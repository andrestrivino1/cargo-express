...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Editar Salida #{{ $gateEvent->id }}</h1>
    <a href="{{ route('gate-out.show', $gateEvent->contenedor) }}" class="btn btn-outline-secondary">
...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <form action="{{ route('gate-out.update', $gateEvent) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-3">
                <label for="hora" class="form-label">Fecha y hora de salida <span class="text-danger">*</span></label>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('gate-out.show', $gateEvent->contenedor) }}" class="btn btn-outline-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</div>
